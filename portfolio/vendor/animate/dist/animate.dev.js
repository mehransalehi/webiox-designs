...
function initElements() {
  document.querySelectorAll('[data-asoop-animation]').forEach(function (e) {
    var animation = JSON.parse(e.getAttribute("data-asoop-animation"));
...
function animate(node, type) {
  var animation = JSON.parse(node.getAttribute("data-asoop-animation"));
...
addEventListener('scroll', function (event) {
  document.querySelectorAll('[data-asoop-paralex-animation]').forEach(function (e) {
...
function translate(node, res) {
  ...
  var animation = JSON.parse(node.getAttribute("data-asoop-paralex-animation"));
  var ruleStr = '';
